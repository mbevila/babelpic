...
Our dataset was annotated manually and then extended using an automatic concept verification technique that exploits [VLP](https://github.com/LuoweiZhou/VLP).
